...
cluster_cell_net <- function(input_ex_sc, input_cell_net, verbose = T, cluster_method = "eigen", crossing_edge_weight = 1, internal_edge_weight = 10){
  ...
  if(cluster_method == "eigen"){
    ...
    input_ex_sc$eigen_clusters <- paste0("eigen_", clusters$membership)
  }
  ...
  if(cluster_method == "greedy"){
    ...
    input_ex_sc$greedy_clusters <- paste0("greedy_", clusters$membership)
  }
