...
filtered_data <- pre_filter(input = sc_dat, threshold = 1, minCells = 10, minUMI = 1000, maxUMI = 10000)  
...
rownames(fData(ex_sc_example))[which(fData(ex_sc_example)$Markers == "Cluster6")]
```
