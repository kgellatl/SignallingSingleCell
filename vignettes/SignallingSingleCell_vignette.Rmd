...
plot_tsne_metadata(ex_sc_example, color_by = "Cluster", title = "Spectral Cluster on iPCA components") # this function is flexible for plotting any metadata onto a 2d tsne mapping
```
...
plot_scatter(ex_sc_example, gene1 = "Tnf", gene2 = "Ccl4", title = "Clusters over Time", color_by = "Timepoint", facet_by = "Cluster", size = 0.2)
                   
plot_violin(input, title = "Actb across clusters", gene = "Gapdh", color_by = "Timepoint", facet_by = "Cluster", size = 1, ncol = 3)
