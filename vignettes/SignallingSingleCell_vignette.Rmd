...
plot_violin(ex_sc_example, title = "Tnf across clusters", gene = "Tnf", color_by = "Cluster", facet_by = "Timepoint", size = 1, ncol = 3)

ex_sc_example_subset <- subset_ex_sc(ex_sc_example, variable = "Timepoint", select = c("1hr"))

plot_tsne_metadata(ex_sc_example_subset, color_by = "Cluster", title = "1hr cells") # this function is flexible for plotting any data onto a 2d tsne mapping

plot_violin(ex_sc_example_subset, title = "Actb across clusters", gene = "Actb", facet_by = "Cluster", size = 1, ncol = 3, color_by = "Cluster")
...
plot_scatter(input = ex_sc_example, gene1 = marker_list$Cluster4[1], gene2 = marker_list$Cluster4[2], facet_by = "Cluster", color_by = "Cluster") # A scater plotting function. Note the correlation of the marker genes.
