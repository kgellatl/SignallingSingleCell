...
ex_sc_norm <- cluster_sc(ex_sc_norm, dimension = "Comp", method = "spectral", num_clust = 4)
...
plot_scatter(input = ex_sc_norm, title = "Top 2 markers for Cluster 4", gene1 = "Emr1", gene2 = "Tnf", facet_by = "Cluster", color_by = "Timepoint", logscale = FALSE) # A scater plotting function. Note the correlation of the marker genes.
...
plot_tsne_gene(mDC_0hr, genes = unlist(panels), title = "")
...
## SVM training on cells pass gate for flow
